...
void append_string_name(name_t *, string_t *);
...
name_t *getname_fn(const wchar_t *, size_t, boolean_t, boolean_t *);
...
source_t *source_from_wchar(wchar_t *);
wchar_t source_popchar(source_t *);
wchar_t source_peekchar(source_t *);
wchar_t *wchar_alloc(size_t);
